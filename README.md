...
用電時沒風（缺口）也不算，且**嚴格不跨區間**。圖中綠色＝已匹配、灰色＝缺口、藍線＝風電發電
（夜強日弱，超出用電輪廓即外溢）。系統**帳面 RE% 62.8% → 逐時 CFE% 58.8%**，差距即時間錯配；
逐客戶更明顯——白天班的電源管理 93.1%→73.3%，而 24 小時平載的半導體無落差。可切換「全系統／
...
![逐時（24/7 CFE）匹配](docs/images/cfe-hourly.png)
